defmodule Homunculus.Inline do
  def help(inline_query) do
    %{"id" => id} = inline_query
    request_body = Jason.encode!(%{"inline_query_id" => id, "results" => [], "switch_pm_text" => "Get help with inline commands", "switch_pm_parameter" => "inline_help"})
  ...
  def rot13(inline_query) do
    ...
    case String.split(query) do
      [_ | tail] when tail != [] ->
        ...
        IO.inspect(results)
        request_body = Jason.encode!(%{"inline_query_id" => id, "results" => results})
